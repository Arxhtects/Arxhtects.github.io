...
function buidPage(nftBlocks, nftMeta) {
  if(nftBlocks.length >= 1) {
    ...
    for(let i = 0; i < nftList.length; i++) {
      $("#data > .wrapper").append("<div class='metabox' data-subtype='" + nftList[i]['subtype'] + "'><div class='left-wrap'><div class='type " + nftList[i]['subtype'] + "'><span>SubType</span><h4>" + nftList[i]['subtype'] + "</h4></div><div class='card'><h4><span>height</span><br />" + nftList[i]['height'] + "</h4><h4><span>Confirmed</span><br />" + nftList[i]['confirmed'] + "</h4><h4><span>Type</span><br />" + nftList[i].contents['type'] + "</h4></div></div><div class='info-wrap'><h4><span>BlockAccount</span><br />" + nftList[i]['blockAccount'] +"</h4><h4><span>Representative</span><br />" + nftList[i].contents['representative'] + "</h4><h4><span>Hash</span><br />" + nftList[i]['hash'] +"</h4><h4><span>Link</span><br />" + nftList[i].contents['link'] + "</h4><h4><span>Previous</span><br />" + nftList[i].contents['previous'] + "</h4></div><div class='end'><h4 class='view-jsonraw'><span>View</span><br />Raw Json</h4></div><div class='json-wrap'><div>" + JSON.stringify(nftList[i]) + "</div></div></div>");
    }
